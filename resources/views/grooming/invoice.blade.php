...
<div class="flex items-start justify-between gap-4 mb-6">
    ...
    <div class="flex-1">
        ...
        <h1 class="text-xl md:text-3xl font-black text-[#6250B4] leading-tight">
            Invoice Booking
            <br class="md:hidden">
            Grooming
        </h1>
    ...
    <div class="shrink-0 text-right">
        ...
        <div class="mt-1 px-3 py-2 rounded-xl bg-[#F4F0FF]">

            <span class="block text-base md:text-lg font-black text-[#6250B4] leading-tight">
                {{ $data['kode_booking'] }}
            </span>
